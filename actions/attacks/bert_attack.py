...
class BERTAttacker(ClassificationAttacker):
    ...
    def attack(self, victim: Classifier, sentence, goal: ClassifierGoal):
        ...
        # original label
        has_sep = "[sep]" in feature.seq.split() # BoolQ can have a [SEP] between the question and the passage
        ...
        to_skip_until = 0
        if has_sep:
            for iidx, wd in enumerate(words):
                if wd == "[sep]":#tokenizer.sep_token:
                    to_skip_until = iidx+1
        ...
        for top_index in list_of_index:
            ...
            for substitute in substitutes:               
                ...
                temp_replace[top_index[0]] = substitute # words[top_index[0]] replaced by substitute!
