...
from transformers import set_seed, AutoConfig, AutoTokenizer, AutoModelForSeq2SeqLM, get_linear_schedule_with_warmup, \
...
def main(args, seed):
    ...
    data_collator_for_training1 = Data_Collator_for_Training(tokenizer, args, mask_inference=False,
                                                             dropout_context=args.dropout_context)
    train_dataloader1 = DataLoader(trainset, collate_fn=data_collator_for_training1, sampler=train_sampler1,
    ...
    for epoch in trange(int(args.num_epoch), desc="Epoch"):
        ...
        epoch_iterator = tqdm(zip(*train_dataloader_list), desc="Train Iteration at Epoch {}".format(epoch),
