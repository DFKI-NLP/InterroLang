...
dataset_file = "../../data/dailydialog_dataset/dataset_da_val.csv"
colname = "dialog"
...
# slots:
# id, class_names/fixed, number, includetoken, metric/fixed, data_type/fixed
print('include_tokens:', include_tokens)
print('ids:', ids)
print('numbers:', numbers)

# fixed slot values
class_names = ["true", "false", "0", "1", "offensive", "neutral", "non-offensive", "hate speech", "no hate speeech", "inform", "question", "directive", "commissive"] #NB: extend these class labels based on config?
metrics = ["accuracy", "acc", "f1", "f 1", "roc", "precision", "prec", "recall", "rec", "sensitivity", "specificity", "ppv", "npv", "positive predictive value", "negative predictive value"]
data_types = ["training", "testing", "developement", "dev", "evaluation", "eval", "train", "test"]

data = {"includetoken":include_tokens,"id":ids,"number":numbers, "class_names":class_names, "data_type":data_types, "metric":metrics}
